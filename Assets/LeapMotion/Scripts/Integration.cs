    ...
    public class ConsolidatedController : Controller
    {
        ...
        public new Frame Frame()
        {
            ...
            for (int i = 0; i < _listOfControllers.Count; i++)
            {
                ...
                {
                    currentFrames.Add(((ReceiverController) _listOfControllers[i]).Frame());
                }
            }
            ...
            Debug.Log("Number of hands = " + newFrame.Hands.Count);
            return newFrame;
        }

        public new void Frame(Frame toFill)
        {
            toFill = Frame();
        }
        ...
        public new void Frame(Frame toFill, int history)
        {
